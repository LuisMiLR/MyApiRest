...
// inserer dans la base de donnée des users : un nouvelle utilisateur
...
//Mise à jour de l'utilisateur indiqué dans l'id
    
router.put('/users/:id', (req, res) => { 
        const userId = req.params.id;
        const { lastName, firstName, email, password, role } = req.body;
        const updateUser = { lastName, firstName, email, password, role} ;
