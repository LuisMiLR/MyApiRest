...
exports.getUniqueId = (users) => {
    ...
    //On calcule l'identifiant le plus grand parmis les id de existant existant, grace a la methode native js reduce() qui permet de comparer les elements 2 a 2 dans un tableau
