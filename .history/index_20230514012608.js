...
//ajout d'un element à la collection de ressources des pokemons
app.post('/api/pokemons', (req, res) => {
    const id = getUniqueId (pokemons)
    //on fusionne les données du pokemon recu via la requette http entrante avec id unique qu'on a générée et on ajoute la date de creation
